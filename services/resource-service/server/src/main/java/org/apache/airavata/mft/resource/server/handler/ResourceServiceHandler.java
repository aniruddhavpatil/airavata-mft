...
public class ResourceServiceHandler extends ResourceServiceGrpc.ResourceServiceImplBase {
    ...
    @Override
    public void getOneDriveResource(OneDriveResourceGetRequest request,
        ...
        try {
            this.backend.getOneDriveResource(request).ifPresentOrElse(resource -> {
                ...
                responseObserver.onError(
                        Status.INTERNAL.withDescription("No OneDrive Resource with id " + request.getResourceId())
                                .asRuntimeException());
            });
        } catch (Exception e) {
    ...
    public void deleteOneDriveResource(OneDriveResourceDeleteRequest request, StreamObserver<Empty> responseObserver) {
        try {
            ...
            if (res) {
                ...
                responseObserver.onError(
                        new Exception("Failed to delete OneDrive Resource with id " + request.getResourceId()));
            }
        } catch (Exception e) {
